...
public class TestLocuteur {
	...
	/*
	 * Methode permettant l'enregistrement audio pour le test avec Arecord. Le
	 * locuteur à tester doit parler durant dix secondes en répétant le mot bonjour.
	 */
	...
	/*
	 * Methode realisant la parametrisation, la premiere normalisation, la detection
	 * d'energie et la seconde normalisation.
	 */
	...
	/*
	 * Methode executant la commande compute_test. Commande qui réalise la
	 * comparaison le locuteur a identifier avec les autres modeles de locuteurs
	 */
	...
	/*
	 * Methode qui parcourt le fichier result.res et ajoute renvoie le contenu sous
	 * forme de matreice Chaque ligne du fichier est represente sous forme de ligne
	 * dans la matrice. et chaque mot est stoque dans une case.
	 */
	...
	/*
	 * Methode qui analyse le contenu du fichier result.res puis decide si la
	 * personne testée est identifiée ou non. La methode retourne le prenom et le
	 * nom de la personne si elle est identifiée ou retourne null dans le cas
	 * contraire.
	 */
	...
	/*
	 * Methode qui appele l'ensemble des methodes necessaires pour la réalisation
	 * d'un test
	 */
	boolean tester() {
